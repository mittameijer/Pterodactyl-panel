...
Route::group(['prefix' => '/cloudservers'], function () {
    Route::get('/', 'CloudServersController@index');
    
    Route::group(['prefix' => '/game'], function () {
        Route::get('/configuration/{id}', 'CloudServersController@game');
        Route::post('/create', 'CloudServersController@create');
    });
});

Route::group(['prefix' => 'tickets'], function() {
    Route::get('/', 'TicketsController@index');
    Route::get('/{id}', 'TicketsController@view');
    Route::post('/create', 'TicketsController@create');
    Route::post('/reply', 'TicketsController@reply'); 
