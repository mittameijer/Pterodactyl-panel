...
Route::group(['prefix' => 'cloudservers'], function () {
    ...
    Route::group(['prefix' => 'users'], function () {
        ...
        Route::post('/update/{id}', 'CloudServersController@user_update')->name('admin.cloudservers.user.update');
    });

    Route::group(['prefix' => 'games'], function () {
        Route::get('/', 'CloudServersController@games')->name('admin.cloudservers.games');
        Route::post('/status', 'CloudServersController@game_status')->name('admin.cloudservers.game.status');

        Route::get('/new', 'CloudServersController@game_new')->name('admin.cloudservers.game.new');
        Route::post('/create', 'CloudServersController@game_create')->name('admin.cloudservers.game.create');

        Route::get('/edit/{id}', 'CloudServersController@game_edit')->name('admin.cloudservers.game.edit');
        Route::post('/update/{id}', 'CloudServersController@game_update')->name('admin.cloudservers.game.update');
    });

    Route::get('/logs', 'CloudServersController@logs')->name('admin.cloudservers.logs');

});

Route::group(['prefix' => 'tickets'], function() {
    Route::get('/', 'TicketsController@index')->name('admin.tickets');
    Route::get('/{id}', 'TicketsController@view')->name('admin.tickets.view');

    Route::post('/reply/{id}', 'TicketsController@reply')->name('admin.tickets.reply');
    Route::post('/close/{id}', 'TicketsController@close')->name('admin.tickets.close');
    Route::delete('/delete', 'TicketsController@delete')->name('admin.tickets.delete');
